...
module stemouter() {
  ...
  translate([0,0,bottom_h]) cylinder(d1=topdia,d2=2.4,h=.8); //cube([topdia,topdia,top_h],true);
  ...
  difference() {
    ...
    translate([2.4/2, -5,0]) cube([10,10, stemheight+1]);
    mirror([1,0,0]) translate([2.4/2, -5,0]) cube([10,10, stemheight+1]);
